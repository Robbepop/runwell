...
use super::{FunctionBuilder, function::state};
use crate::ir::{BasicBlockId, IrError, instruction::Instruction};
...
impl<'a> FunctionInstrBuilder<'a> {
    ...
    fn new(builder: &'a mut FunctionBuilder<state::Body>, current: BasicBlockId) -> Self {
